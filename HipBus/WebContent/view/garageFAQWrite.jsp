	...
	<div class="w3-main " style="margin-right: 20%; margin-left: 20%">
		...
		<div class="w3-row">
			<div class="w3-container">
				<form name="writeform" method="post" onsubmit="return faqWriteCheck(this);" action="garageFAQWritePro.do">
					<div class="w3-card-4">
						<header class="w3-container w3-padding-jumbo w3-theme-l3">
							<input class="w3-input" type="text" required name="subject"> <label class="w3-label w3-validate">${str_Subject}</label>
						</header>
						...
						<footer class="w3-container w3-padding-jumbo w3-theme-l3 w3-center">
							<input type="submit" class="w3-btn w3-padding w3-theme-d1 w3-margin-left" value="&#xf00c; ${btn_Write}"> <a href="garageFAQ.do" class="w3-btn w3-padding w3-theme-d1 w3-margin-left">
