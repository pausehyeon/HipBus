	...
	<div class="w3-container w3-content" style="max-width: 1400px;">
		...
		<div class="w3-row">
			...
			<div class="w3-container w3-center w3-black">
			  <h2><i class="fa fa-close"></i>&nbsp; 회원 탈퇴 </h2>
			</div>
			...
			<form id="inputform" class="w3-container">
				<p>
					...
					<div class="w3-text-red w3-xsmall w3-right">*탈퇴 시 모든 정보가 삭제되며 복구할 수 없습니다. 신중히 결정해주세요</div>
				</p>
				<br><br>
				<div class="w3-center">
					<input type="submit" value="탈퇴하기" class="w3-btn w3-padding w3-black w3-margin">				
				</div>
