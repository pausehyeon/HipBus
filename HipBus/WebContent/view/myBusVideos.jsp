						...
						if (request.httpRequest.status == 200) {
							...
							if (jsonData.pageInfo.totalResults != 0) { // 동영상이 있는경우
								...
								if (jsonData.nextPageToken
									...
									video += '<a class="w3-btn w3-hover-red w3-round" href="myBusVideos.do?driver=${driver}&nextPageToken='
									...
									video += '<div class="w3-row w3-center">';
									video += '<div class="w3-col w3-padding-12">'
									video += '<a class="w3-btn w3-hover-red w3-round" href="myBusVideos.do?driver=${driver}&prevPageToken='
											+ jsonData.prevPageToken
											+ '">◀</a>';
									video += '</div></div>';
