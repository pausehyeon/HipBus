					...
					<c:if test="${driver eq sessionScope.memEmail}">
						<div class="w3-row-padding w3-margin-top w3-margin-bottom">
							<div class="w3-col m12">
								<a href="myBusUpcomingWrite.do?driver=${driver}" class="w3-btn w3-padding w3-theme-d5 w3-margin-left w3-right"> <i class="fa fa-pencil w3-margin-right"></i>${str_post}</a>
							</div>
						</div>
					</c:if>
