...
<body>
	...
	<div class="w3-main " style="margin-right: 20%; margin-left: 20%">
		...
		<div class="w3-row w3-container" style="margin-top: 64px">
			...
			<hr>
			<!-- 이 버튼은 관리자에게만 보임 -->
			<a href="garageNewsWrite.do?email=${sessionScope.memEmail}" class="w3-btn w3-padding w3-theme-d1 w3-margin-left w3-right">	<i class="fa fa-pencil-square-o w3-margin-right"></i>${str_Write}</a>
		</div>
