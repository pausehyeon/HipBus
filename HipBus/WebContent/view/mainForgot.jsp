...
<script type="text/javascript">
	...
	function verifyemail() {
		...
		request = new Request(verifyemailresult, "verifyEmailResult.do",
				"POST", params);
		request.sendRequest();
	}
	...
	<div class="w3-content"
		...
		<div class="w3-container w3-padding-128"
			...
			<div class="w3-container w3-center w3-black">
				<h2>
					<i class="fa fa-question-circle w3-xxsmall"></i>${str_searchPassword}
				</h2>
			</div>

			<form name="inputform" action="mainForgotPro.do" id="inputform" class="w3-container" >
				<p>
					<label>Email</label> <input id="email" type="text" class="w3-input"
						>
				<div class="w3-text-blue w3-xsmall w3-right" id="emailresult">${str_noEmail}</div>
				</p>
				<br>
				<div class="w3-center">
					<input type="submit" value="${str_newPasswordSend}"
