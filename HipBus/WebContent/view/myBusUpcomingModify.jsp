...
<body class="w3-theme-l5">
	...
	<div class="w3-container w3-content" style="max-width: 1400px;">
		...
		<div class="w3-row">
			...
			<!-- 여기서부터 -->
			<div class="w3-col m7">
				<div id="modifyForm" class="w3-container w3-card-2 w3-white w3-round w3-margin-bottom w3-margin-left w3-margin-right w3-padding-32 w3-padding-xxlarge">
					<form name="modifyUpcomingForm" action="myBusUpcomingModifyPro.do?driver=${driver}&num=${num}" method="post" enctype="multipart/form-data">
						...
						<div class="w3-row-padding w3-padding-12">
							<input class="w3-input" type="text" required="required"
									name="showName" value="${upcomingDto.subject}">							 
						...
						<div class="w3-row-padding">
							<div class="w3-col m6">
								<div class="w3-row-padding w3-right-align">
									<input type="text" class="w3-input" required="required"
											name="location" value="${upcomingDto.perf_place}"> 
							...
							<div class="w3-col m6">
								<div class="w3-row-padding w3-right-align">
									<input type="text" class="w3-input" required="required"
											name="cast" value="${upcomingDto.perf_cast}"> 
							...
							<div class="w3-col m6">
								<div class="w3-row-padding w3-right-align">
									<input type="number" min="0" step="5" placeholder="분 단위" class="w3-input" required="required"
											name="runningTime" value="${upcomingDto.perf_runningtime}">
							...
							<div class="w3-col m6">
								<div class="w3-row-padding w3-right-align">
									<input type="number" min="0" step="100" class="w3-input"
											name="price" value="${upcomingDto.perf_price}"> 
									<label>티켓가격</label>
								</div>
							</div>
						</div>
