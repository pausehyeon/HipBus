				...
				<div class="w3-center w3-padding-64">
					<ul class="w3-pagination">
						...
						<c:if test="${startPage > pageBlock}">
							<li><a href="garageWanted.do&searchType=${searchType}&keyword=${keyword}">[◀◀]</a></li>
							<li><a href="garageWanted.do?pageNum=${startPage-pageBlock}&searchType=${searchType}&keyword=${keyword}">[◀]</a></li>
						</c:if>
						<c:forEach var="i" begin="${startPage}" end="${endPage}">
							...
							<c:if test="${i != currentPage}">
								<li><a href="garageWanted.do?pageNum=${i}&searchType=${searchType}&keyword=${keyword}">[${i}]</a></li>
							</c:if>
						</c:forEach>
						<c:if test="${pageCount > endPage}">
							<li><a href="garageWanted.do?pageNum=${startPage+pageBlock}&searchType=${searchType}&keyword=${keyword}">[▶]</a></li>
							<li><a href="garageWanted.do?pageNum=${pageCount}&searchType=${searchType}&keyword=${keyword}">[▶▶]</a></li>
						</c:if>
					</ul>
				</div>
			</div>
