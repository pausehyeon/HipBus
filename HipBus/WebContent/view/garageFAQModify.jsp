	...
	<div class="w3-main " style="margin-right: 20%; margin-left: 20%">
		...
		<div class="w3-row">
			<div class="w3-container">
				<form name="writeform" method="post" onsubmit="return faqModifyCheck(this);" action="garageFAQModifyPro.do?num=${article.num}">
					<div class="w3-card-4">
						<header class="w3-container w3-padding-jumbo w3-theme-l3">
							<input class="w3-input" type="text" name="subject" required value="${article.subject}"><label class="w3-label w3-validate">${str_Subject}</label>
						</header>
