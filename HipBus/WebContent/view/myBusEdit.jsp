				...
				<div
					...
					<div class="w3-content w3-padding-64">
						...
						<form id="inputform" class="w3-container">
							...
							<div class="w3-text-red w3-xsmall w3-right">*파일 형식에 맞지
								않습니다.</div>
							</p>
							<br> <br>
							...
							<div class="w3-text-red w3-xsmall w3-right">*이미 존재하는
								닉네임입니다.</div>
							</p>
							<br> <br>
							<p>
					...
					<div class="w3-content w3-padding-64">
						...
						<p class="w3-responsive">
							<i class="fa fa-check"></i> 탈퇴할 경우 재사용 및 복구가 불가능합니다.<br> 탈퇴
							후 사이트에 게시한 내용을 수정/삭제 할 수 없습니다.
						</p>
						<form id="signoutform" class="w3-container">
							<p>
								<label>Password</label> <input class="w3-input" type="text">
							</p>
						<br> <br> <input class="w3-check" type="checkbox">
