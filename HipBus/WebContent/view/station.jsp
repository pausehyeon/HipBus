...
<div class="w3-main " style="margin-right:20%; margin-left:20%">
	<div class="w3-row w3-container" style="margin-top:64px">
		...
		<hr>
		<a href="station_write.do" class="w3-btn w3-padding w3-theme-d1 w3-margin-left w3-right"><i class="fa fa-pencil-square-o w3-margin-right"></i>글쓰기</a>
	</div>
	<div class="w3-row">
		<div class="w3-twothird">
			...
			<hr>
				...
				<div class="w3-row w3-margin-bottom">
					<div class="w3-twothird w3-container">
					  <a href="station_read.do"><h5>[잡담] Fiesta de Alguien 예매합시다 </h5></a>
					</div>
					<div class="w3-third w3-container">
					  <p class="w3-right w3-tiny">작성자:누구 | 작성일:2016-12-19 | 조회수: 0</p>
					</div>
				...
				<div class="w3-row w3-margin-bottom">
					<div class="w3-twothird w3-container">
					  <a href="mainstation_readstation_read.do"><h5>[가사] 가사 평 좀 </h5></a>
					</div>
					<div class="w3-third w3-container">
					  <p class="w3-right w3-tiny">작성자:아무개 | 작성일:2016-12-19 | 조회수: 0</p>
					</div>
