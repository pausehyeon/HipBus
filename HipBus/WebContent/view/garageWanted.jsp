...
<body>
	...
	<form name="searchform" method="post" action="garageWantedSearch.do" onsubmit="return search()">
		...
		<a href="garageWanted.do">[◀◀]</a>
		<a href="garageWanted.do?pageNum=${startPage-pageBlock}">[◀]</a>
	</c:if>
	<c:forEach var="i" begin="${startPage}" end="${endPage}">
		...
		<c:if test="${i != currentPage}">
			<a href="garageWanted.do?pageNum=${i}">[${i}]</a>
		</c:if>
	</c:forEach>
	<c:if test="${pageCount > endPage}">
		<a href="garageWanted.do?pageNum=${startPage+pageBlock}">[▶]</a>
		<a href="garageWanted.do?pageNum=${pageCount}">[▶▶]</a>
	</c:if>			
		<!-- 
