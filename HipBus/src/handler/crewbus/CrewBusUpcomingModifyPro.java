...
@Controller
public class CrewBusUpcomingModifyPro implements CommandHandler {
	@Resource(name="myBusDao")
	private MyBusDao mybusDao;
	@RequestMapping("/crewBusUpcomingModifyPro.do")
	@Override
	public ModelAndView process(HttpServletRequest request, HttpServletResponse response) throws HandlerException {
		...
		return new ModelAndView("crewBusUpcomingModifyPro");
	}
