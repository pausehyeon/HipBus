...
@Controller
public class CrewBusUpcomingWritePro implements handler.CommandHandler{
	@Resource(name = "myBusDao")
	MyBusDao dao;
	@RequestMapping("/crewBusUpcomingWritePro.do")
	@Override
	public ModelAndView process(HttpServletRequest request, HttpServletResponse response) throws HandlerException {
		...
		try {
			...
			dto.setNick(dao.getMember((String)request.getSession().getAttribute("memEmail")).getNick());
			...
			int result = dao.writeUpcoming(dto);
		...
		return new ModelAndView("crewBusUpcomingWritePro");
	}
}
