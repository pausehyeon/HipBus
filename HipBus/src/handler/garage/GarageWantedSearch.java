...
@Controller
public class GarageWantedSearch implements CommandHandler{
	
	@Resource(name="garageDao")
	private GarageDao garageDao;
	
	@RequestMapping("/garageWantedSearch.do")
	@Override
	public ModelAndView process(HttpServletRequest request, HttpServletResponse response) throws HandlerException {
		...
		if( count != 0 ) {
			...
			List <WantedDto> WantedList = garageDao.getWantedArticles(map);
			request.setAttribute( "WantedList", WantedList );
