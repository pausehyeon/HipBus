	...
	public ModelAndView process(HttpServletRequest request, HttpServletResponse response) throws HandlerException {
		...
		if ( forgotResult == 1 ) {
			...
			new MailService(email, "비밀번호 분실 메일입니다.", 
				...
				+"<a href='http://localhost:8080/HipBus/mainValidatePro.do?code="+code+"&email="+email+"'style='background-color:#f44336;color:white;display:block;text-decoration:none;border-radius:3px;max-width:360px;font-size:1.3em;text-align:center;padding:20px;font-weight:normal;letter-spacing:1px;margin:15px'>임시 비밀번호 발급</a>"
				+"</center>"
